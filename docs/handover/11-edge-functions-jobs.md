...
- UI: Communications → **Instalment Reminders** (`src/components/communications/InstalmentRemindersPanel.tsx`, `src/hooks/useInstalmentReminders.ts`). Sending, skipping and stopping require admin/manager.
