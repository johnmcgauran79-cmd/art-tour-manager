-- Fix the auto_archive_completed_tours function - remove invalid 'cancelled' status
...
BEGIN
  -- Archive tours where end_date was 7+ days ago and status is not already archived
  UPDATE tours
