...
-- Add a new column to task_templates to specify which date field to use
ALTER TABLE public.task_templates 
ADD COLUMN date_field_type text DEFAULT 'tour_start_date';

-- Add a constraint to ensure only valid date field types are used
ALTER TABLE public.task_templates 
...
-- Update the generate_tour_operation_tasks function to handle different date fields
...
-- Update existing templates to have the default date_field_type
UPDATE public.task_templates 
SET date_field_type = 'tour_start_date' 
WHERE date_field_type IS NULL;
