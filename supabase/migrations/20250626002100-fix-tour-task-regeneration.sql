...
-- Fix the tour date change trigger function to properly regenerate tasks
...
-- Update the generate_tour_operation_tasks function to ensure it works correctly
  ...
  LOOP
    ...
    IF v_reference_date IS NOT NULL THEN
      ...
      IF NOT EXISTS (
        ...
        -- Auto-assign to managers/admins using the task ID we just got
