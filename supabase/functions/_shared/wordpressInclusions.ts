...
//
// Mirrored at src/lib/mcp/wordpress/inclusions.ts — keep both in lockstep.
...
/** Load a tour's inclusion/exclusion items + website description. */
// deno-lint-ignore no-explicit-any
export async function loadArtInclusions(supabase: any, tourId: string): Promise<
  | { error: string }
  | {
...
> {
  ...
  return {
    ...
    website_description: (tour.website_description as string | null) ?? "",
  };
}
