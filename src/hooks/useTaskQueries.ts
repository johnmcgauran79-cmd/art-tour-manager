...
export interface Task {
  ...
  status: 'not_started' | 'in_progress' | 'waiting' | 'completed' | 'cancelled' | 'archived' | 'not_required' | 'with_third_party' | 'awaiting_further_information' | 'approval_required' | 'approved' | 'changes_needed';
