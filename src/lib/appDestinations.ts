...
export const APP_DESTINATIONS: AppDestination[] = [
  ...
  { id: "instalment-reminders", label: "Payment Reminders", group: "Pages", keywords: "instalment installment final balance payment reminder overdue chase invoice due", path: "/communications?tab=instalments", access: "adminManager" },
