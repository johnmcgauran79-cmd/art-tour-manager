...
import updateRecordFieldsTool from "./tools/update-record-fields";
import getContactDetailsTool from "./tools/get-contact-details";
import updateContactTool from "./tools/update-contact";
import manageExternalLinkTool from "./tools/manage-external-link";
...
import getDataQualityTool from "./tools/get-data-quality";
...
export default defineMcp({
  ...
  tools: [
    ...
    createHotelTool,
    updateHotelTool,
    updateRecordFieldsTool,
    getContactDetailsTool,
    updateContactTool,
    manageExternalLinkTool,
    deleteHotelTool,
    ...
    listLeadsTool,
    getLeadTool,
    listLeadActivitiesTool,
    listCrmSettingsTool,
    getCrmReportTool,
    getDataQualityTool,
    listTourInterestsTool,
    listCrmAutomationTool,
    listFormSubmissionsTool,
    listLeadFormsTool,
    updateLeadTool,
    logLeadActivityTool,
    upsertTourInterestTool,
    // Marketing
    listMarketingCampaignsTool,
    getMarketingCampaignTool,
    listCampaignRecipientsTool,
    listCampaignEventsTool,
    listMarketingAudiencesTool,
    countMarketingAudienceTool,
    getTourMarketingIntelligenceTool,
    listTourMarketingPeopleTool,
    listMarketingLinkRulesTool,
    getContactMarketingStatusTool,
    listEmailSuppressionsTool,
    // Communications hub
    listMailboxesTool,
    searchCorrespondenceTool,
    getCorrespondenceMessageTool,
    // Sending (switched off until authorised)
    sendMarketingCampaignTool,
    scheduleMarketingCampaignTool,
    sendIndividualEmailTool,
  ],
});