      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div>
          ...
          <Input
            ...
            placeholder="Auto-generated by Xero, or enter manually"
          />
          <p className="text-xs text-muted-foreground mt-1">
            Leave blank to auto-populate when Xero invoice is created. Enter <strong>0</strong> for host or complimentary bookings.
          </p>
        </div>
