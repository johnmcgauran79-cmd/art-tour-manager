...
export const EmailTemplatePreviewModal = ({ open, onOpenChange, template, subjectTemplate, contentTemplate }: EmailTemplatePreviewModalProps) => {
  ...
  const renderedHtml = (() => {
    ...
    if ((mergeData as any).tour_dates_not_confirmed) tourRows.push(`<tr><td style="${gridLabelStyle}"></td><td style="${gridValueStyle}font-weight:400;font-style:italic;color:#8a6d1f;">Provisional Tour dates - Race date still to be confirmed by the race club.</td></tr>`);
