...
const MERGE_FIELDS = {
  ...
  booking: [
    ...
    '{{booking_group_name}}', '{{booking_dietary_restrictions}}', '{{booking_extra_requests}}',
    '{{booking_medical_conditions}}', '{{booking_emergency_contact_name}}', '{{booking_passport_number}}'
  ],
  hotel: [
